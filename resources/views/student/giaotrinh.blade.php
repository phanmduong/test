                ...
                <div class="col s12 m3" id="navigation">
                    ...
                    <ul class="collapsible" data-collapsible="expandable">
                        @foreach($registers as $register)
                            <li>
                                <div class="collapsible-header" id="click{{$register->studyClass->course->id}}">
                                    ...
                                    <span style="display: inline-block; line-height: 20px; position: relative; top: -6px;">{{$register->studyClass->course->name}}</span>
                                </div>
                                <div class="collapsible-body ">
                                    <ul class="collection">
                                        @foreach($register->studyClass->course->lessons as $item)
