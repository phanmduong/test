                                    ...
                                    <div id="submitInputs" class="gdlr-item gdlr-content-item" style="margin-bottom: 60px;"><p></p>
                                        ...
                                        <div role="form" class="wpcf7" id="wpcf7-f4-o1" lang="en-US" dir="ltr">
                                            ...
                                            <form action="/hotelmaster/dark/contact-page-2/#wpcf7-f4-o1" method="post"
                                                ...
                                                <p>Thời gian bắt đầu<br>
                                                    <span class="wpcf7-form-control-wrap your-subject"><input
                                                            type="datetime-local" v-model="starttime" value="" size="40"
                                                            class="wpcf7-form-control wpcf7-text" aria-invalid="false" style="padding: 6px 12px"></span>
                                                </p>
                                                <p>Thời gian kết thúc<br>
                                                    <span class="wpcf7-form-control-wrap your-subject"><input
                                                            type="datetime-local" v-model="endtime" value="" size="40"
                                                            class="wpcf7-form-control wpcf7-text" aria-invalid="false" style="padding: 6px 12px"></span>
                                                </p>
                                                <p>Lời nhắn<br>
                                                ...
                                                <br>
                                                <p><input id="submitbutton" type="submit" value="Gửi"
                                                            v-on:click="submit"
            ...
            methods: {
                ...
                submit: function () {
                    ...
                    if(this.starttime == '' || this.endtime == ''){
                        this.alert = 'Vui lòng nhập thời gian';
                        return;
                    }
