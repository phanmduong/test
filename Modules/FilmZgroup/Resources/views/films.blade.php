        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse ">
                <ul id="menu-main-navigation" class="nav navbar-nav">
                    ...
                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-229"><a
        ...
        <div class="row">
                        ...
                        <div class="row movie-tabs">
                            <div class="col-md-3 col-sm-5">
                                <div style="position: relative;">
                                    ...
                                    <a class="image" href="/film/{{$film->id}}" title={{$film->name}}
                                            style="background: url({{$film->avatar_url}}) center center / cover;"></a>
                                </div>
                            </div>
                            <div class="col-md-9 col-sm-7">
                                <span class="title">{{$film->genre}}</span>
                                <h3 class="no-underline"><a href="/film/{{$film->id}}"
                                                            style="color: black">{{$film->name}}</a></h3>
                                <p style="text-align: justify; margin-top: -10px">{{mb_substr($film->summary,0,300) . "..."}}</p>
            ...
            <aside class="col-sm-3 col-sm-push-1 sidebar">
                ...
                <div class="widget">
                    <h4>Phân loại</h4>
                    <ul>
                        <li><a href="/film?category=showing" class="{{$classShowing}}">Phim đang chiếu</a></li>
                        <li><a href="/film?category=coming-soon" class="{{$classComing}}">Phim sắp chiếu</a></li>
                    </ul>
                </div>
            </aside>
        </div>
        ...
        <div class="footer-middle" style="border-top: 1px solid #444">
                ...
                <div class="footer-column pull-left">
                    <div style="float: right;">
                        ...
                        <ul class="links">
                            ...
                            <li><span><a href="#">Hướng dẫn mua hàng</a></span></li>
                            <li><span><a href="#">Phương thức thanh toán</a></span></li>
                            <li><span><a href="#">Câu hỏi thường gặp</a></span></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="column column2">
                <div class="footer-column pull-left">
                    ...
                    <ul class="links">
                        <li><span><a href="#">Giới thiệu Ledahlia</a></span></li>
                        <li><span><a href="#">Tuyển dụng</a></span></li>
                        <li><span><a href="#">Liên hệ quảng cáo</a></span></li>
                        <li><span><a href="#">Chính sách bảo mật</a></span></li>
                        <li><span><a href="#">Quy định sử dụng</a></span></li>
                    </ul>
                </div>
            </div>
            <div class="column column3">
                <div class="footer-column pull-left">
                    ...
                    <ul class="links">
                        ...
                        <li><span><a href="#">Nâng hạng thành viên</a></span></li>
                        <li><span><a href="#">Khuyến mãi</a></span></li>
