...
@section('content')
    ...
    <div class="movie-search" style="height: 46px; display: none; transition: transform 0.3s">
        <form role="search" method="get" id="searchform" action="{{url('/film')}}">
            <div>
                <input type="text" value="" name="search" id="search" placeholder="Tìm phim" style="padding: 12px 15px">
            ...
            <div class="navbar-collapse collapse ">
                <ul id="menu-main-navigation" class="nav navbar-nav">
                    ...
                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-254" style="display: none"><a title="Events"
                                                                                                          href="Events.thml">Sự
                            kiện</a></li>
                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-210 active"><a
    ...
    <div id="content_hero"
         style="background-image: url(http://specto.klevermedia.co.uk/wp-content/uploads/2017/07/hero-contact.jpg);">
    ...
    <div class="fw-page-builder-content">
        ...
        <section style=" padding-top: 75px; padding-bottom: 30px; border-width: 0px 0px 0px 0px"
                 id="section_7f71e78d5089ec773ed20f33b9f6cb72" class="fw-main-row ">
            <div class="fw-container">
                <div class="fw-row">

                    <div style="padding: 0 15px 0 15px;" class="fw-col-xs-12 ">
                        <div class="fw-map">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3724.329251454933!2d105.84002231532739!3d21.019507893469058!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ab8fddc6ec9f%3A0x4f9a1dfd4c61d004!2zMTA2IFnhur90IEtpw6p1LCBOZ3V54buFbiBEdSwgSGFpIELDoCBUcsawbmcsIEjDoCBO4buZaSwgVmlldG5hbQ!5e0!3m2!1sen!2s!4v1531554253954"
        ...
        <section style=" padding-top: 0px; padding-bottom: 75px; border-width: 0px 0px 0px 0px"
            ...
            <div class="fw-container">
                ...
                <div class="fw-row">
                            ...
                            <form method="post" action="{{url('/message')}}">
                                <div class="wrap-forms">
                                    ...
                                    <div class="fw-row">
                                        <div class="fw-col-xs-12 form-builder-item">
                                            <div class="field-text">
                                                <label for="id-4">Tên <sup>*</sup> </label>
                                                <input name="name" type="text" id="id-4"
                                                       required="required">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="fw-row">
                                        <div class="fw-col-xs-12 form-builder-item">
                                            <div class="field-text">
                                                <label for="id-6">Bạn biết đến chúng tôi từ đâu? </label>
                                                <input type="text" id="id-6" name="known_from">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="fw-row">
                                        <div class="fw-col-xs-12 form-builder-item">
                                            <div class="field-textarea">
                                                <label for="id-7">Tin nhắn <sup>*</sup> </label>
                                                <textarea name="textarea_ff9c670" placeholder="" id="id-7"
                                                          required="required" name="message_str"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="fw-row"></div>
                    ...
                    <div style="padding: 0 15px 0 15px;" class="fw-col-xs-12 fw-col-sm-2 ">
                    </div>

                    <div style="padding: 0 15px 0 15px; margin-top: 30px" class="fw-col-xs-12 fw-col-sm-4 ">


                        <div class="icon-row" style="min-width: 230px">
                            <div class="col">
    <span class="circle">
      <i class="fa fa-map-marker"></i>
                            ...
                            <div class="col">
                                ...
                                <p style="color: #82242a;">106 Yết Kiêu, Phường Nguyễn Du, Quận Hai Bà Trưng, Hà Nội</p>
                            </div>
                        </div>
    ...
    <span class="circle">
      <i class="fa fa-envelope-open"></i>
                            ...
                            <div class="col">
                                ...
                                <p style="color: #82242a;">contact@ledahlia.vn</p>
                            </div>
                        </div>
    ...
    <span class="circle">
      <i class="fa fa-phone"></i>
                            ...
                            <div class="col">
                                ...
                                <p style="color: #82242A!important;">0942929990</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section style=" padding-top: 75px; padding-bottom: 75px; border-width: 1px 0px 0px 0px"
                 id="section_f9b06791246240ccbba1f7b5ae56aaab" class="fw-main-row ">
            <div class="fw-container">
                <div class="fw-row">
    ...
    <script>
        ...
        $(".submit input").click(function (event) {
            if ($("#id-4").val().length > 0 && $("#id-5").val().length > 0 && $("#id-7").val().length > 0) {
