...
class TopicServiceProvider extends ServiceProvider
{
    ...
    {
        $this->publishes([
            __DIR__.'/../Config/config.php' => config_path('topic.php'),
        ], 'config');
        $this->mergeConfigFrom(
            __DIR__.'/../Config/config.php', 'topic'
        );
    }
    ...
    {
        $viewPath = resource_path('views/modules/topic');
    ...
    {
        $langPath = resource_path('lang/modules/topic');
